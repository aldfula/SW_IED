...
// Servo adjustment
#define _DUTY_MAX 2130  // Servo angle: 39 degree
#define _DUTY_NEU 1531  // Servo angle: 0 degree
#define _DUTY_MIN 960   // Servo angle: 121 degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return (612-3.29*X+7.32E-03*X*X-5.56E-06*X*X*X);
}
